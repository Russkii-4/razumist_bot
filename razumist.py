...
async def process_new_user(message: types.Message):
    text = (
        ...
        "Требования:\n"
        "- Веди себя адекватно, чтобы не пришлось утихомиривать мутом на час, сутки, трое суток и тд.\n" 
        "- Не стоит кидаться на всех подряд со словами \"Маму твою ебал\" и тд и тп, если ваше мнение не совпадает со мнением окружающих.\n\n"
        "Запрещается:\n"
        " - Размещение любого контента, относящегося к рекламе, без согласования с `@bella_trice`\n"
        " - Шок контент/порно/политота/религия\n"
        " - Покупка/продажа/обмен аккаунтов, обсуждение \"дешёвой\" голды\n"
        " Спам и флуд также не приветствуются. За отправку 4 стикеров одновременно улетаете в мут на 30 минут\n\n"
        "*Бан за нарушение от 1 дня до пермача.*\n"
        "\n"
        "Получили мут?\n"
        "*Вопросы ко всем админам*, а не к одному лишь `@FrutoSpidoznic`\n"
        "Поэтому имейте в наличии 2-3 юзернейма админов, чтобы можно было с ними связаться\n\n"
        ...
        "   `@aWong`\n\n"
        "Вы не прочитали правила и не сохранили список модеров? Это *ваши проблемы*.\n\n"
        "Администрация *не имеет права выдавать ПЕРМАЧ* по личной неприязни\n\n"
        "*Это собщение удалится после нажатия кнопки \"Прочитал\"*\n\n"
    )
